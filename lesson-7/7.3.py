...
class Cell:
    ...
    def __sub__(self, other):
        if (self.n - other.n) > 0:
            ...
            print(f'У уменьшаемой клетки ячеек меньше чем у вычитаемой\n')
    ...
    def __truediv__(self, other):
        try:
            ...
            print('У клетки делителя не имеется ячеек (деление на ноль)')

    def make_order(self, n_per_row: int) -> str:
        i = 1
        string = ''
        while i <= self.n:
            string += '*'
            if i % n_per_row == 0 and i != self.n:
                string += '\n'
            i += 1
        return string
...
a = a1 + a2
b = c - a1
print(a.make_order(5).__repr__())
print(b.make_order(5).__repr__())
